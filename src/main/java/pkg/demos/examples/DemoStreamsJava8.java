...
public class DemoStreamsJava8 {
    ...
    private List<Integer> squaresList;
    private List<Integer> integers;
    private Random random;

    public void StreamJava7() {
        ...
        mergedString = getMergeStringUsingJava7(strings, ", ");
    ...
    private static String getMergeStringUsingJava7(List<String> strings, String separator) {
